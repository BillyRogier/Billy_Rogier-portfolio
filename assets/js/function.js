...
function positionCircle() {
    if (!/sylviebiscuitsetcie/.test(window.location.href)) {
        window.scrollY < section[1].offsetTop - 70
            ...
            : ((circle.style.top =
                  section[4].offsetTop -
                  window.innerHeight / 0.762 +
                  -0.7 * window.scrollY +
                  "px"),
              (circle.style.left =
                  -(window.innerHeight * (window.innerWidth / 405)) +
    ...
    if (
        ...
        (navLinks.style.opacity = 0),
            ...
            setTimeout(function () {
                ...
                if (
                    window.location.toString().indexOf("sylviebiscuitsetcie") !=
                    25
                ) {
                    positionCircle();
                }
